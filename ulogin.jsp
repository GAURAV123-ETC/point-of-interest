...
//
		...
		session.setAttribute("uid",rs1.getString(1));
		session.setAttribute("city",rs1.getString("city"));
		session.setAttribute("ulat",rs1.getString("lat"));
		session.setAttribute("ulon", rs1.getString("lon"));
