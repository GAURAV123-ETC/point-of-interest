...
<table cellpadding="5">
<tr>
	<td><input size="30" class="form-control1" type="text" id="latitude" Placeholder ="latitude" name="latitude" required/><td><input size="30" type="text" id="longitude" class="form-control1" Placeholder="Longitude" name="longitude"/>
...
<tr>
	<td>	<input class="form-control1" type="text" name="country" placeholder="Country"  id="country" required></td><td align="right"><input type="submit"  value="Next" class="form-control1"/>
</tr>
</table>
