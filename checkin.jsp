...
alert(' Get started retrieve the Geo Properties');
...
<form method="post" action="checkin2.jsp" >
<h2>Check in..</h2><br>
	<head>
		<script
...
<td>
		...
		<div id="map_canvas" style="width:820px;height:400px;border:solid black 1px;"></div>

<tr><td><br><h3>Latitude<br><input class="form-control1"  class="form-control"  type="text" name="latitude" id="latitude" style="width:550px;" value="17.436951506722654">
<TR><td><br><h3>Longitude<br><input class="form-control1"  class="form-control"  type="text" name="longitude" id="longitude" style="width:550px;" value="78.44502579788968" >
...
<input class="form-control"  type="hidden" name="city"id="city">
			...
			<tr><td><input  class="form_settings1"  type="submit"  value="Next" id="button2"/></div>
