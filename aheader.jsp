						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav cl-effect-16">
									<li><a href="admin_home.jsp" data-hover="Home">Home</a></li>
									<li><a href="add_poi_type.jsp" data-hover="Add Poi Category">Add Poi Category</a></li>
									<li><a href="viewpois.jsp" data-hover="View POI's">View POI's</a></li>
